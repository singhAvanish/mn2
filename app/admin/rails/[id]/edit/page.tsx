...
import EditRailClient from "./EditRailClient";

export default async function EditRailPage({ params }: { params: Promise<{ id: string }> }) {
  const { id } = await params; // ✔️ Unwrap Promise correctly

  return <EditRailClient id={id} />;
}
